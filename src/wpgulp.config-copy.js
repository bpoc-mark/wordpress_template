...
const projectURL = 'wordpress-template.test';
...
const jsVendorSRC = 'assets/vendor/*.js';

// Path to place the compiled JS vendors file.
const jsVendorDestination = '../release/vendor/';
...
const watchJsVendor = 'assets/vendor/*.js';
